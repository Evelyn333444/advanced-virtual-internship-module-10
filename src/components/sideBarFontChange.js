    ...
    return (
        <>
            ...
            <aside className={`sidebar ${isOpen ? 'sidebar--open' : 'sidebar--closed'}`}>
                ...
                <div className="sidebar__wrapper" style={{ fontSize: `${fontSize}px` }}>
                    ...
                    <div className="sidebar__bottom">
                        <div className="sidebar__link--wrapper sidebar__font--size-wrapper">
                            ...
                            <div className="sidebar__link--text sidebar__font--size-icon">
                                <button onClick={() => setFontSize(13.5)}>
                            ...
                            <div className="sidebar__link--text sidebar__font--size-icon">
                                <button onClick={() => setFontSize(16.5)}>
                            ...
                            <div className="sidebar__link--text sidebar__font--size-icon">
                                <button onClick={() => setFontSize(19.5)}>
...
export default SideBarFontChange;
