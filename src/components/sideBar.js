            ...
            <aside className={`sidebar ${isOpen ? 'sidebar--open' : 'sidebar--closed'}`}>
                ...
                <div className="sidebar__wrapper">
                    <div className="sidebar__top">
                        <a className="sidebar__link--wrapper" href="/foryou" onClick={close}>
                        ...
                        <a className="sidebar__link--wrapper" href="/library" onClick={close}>
                    ...
                    <div className="sidebar__bottom">
                        <a className="sidebar__link--wrapper" href="/settings" onClick={close}>
                            <div className="sidebar__link--line "></div>
                            <div className="sidebar__icon--wrapper">
                        ...
                        <div className="sidebar__link--wrapper" onClick={() => { handleLogout(); close(); }} style={{ cursor: 'pointer' }}>
                            <div className="sidebar__link--line "></div>
                            <div className="sidebar__icon--wrapper">
                                <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
