                                                                                                                    ...
                                                                                                                    <a className="sidebar__link--wrapper" href="/settings">
                                                                                                                        ...
                                                                                                                        <div className="sidebar__icon--wrapper">
                                                                                                                            <svg stroke="currentColor" fill="none" strokeWidth="0" viewBox="0 0 15 15" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                                                                                                ...
                                                                                                                                <div className="sidebar__link--wrapper sidebar__link--not-allowed">
                                                                                                                                    <div className="sidebar__link--line "></div><div className="sidebar__icon--wrapper">
                                                                                                                                            ...
                                                                                                                                            <div className="sidebar__link--wrapper">
                                                                                                                                                ...
                                                                                                                                                <div className="sidebar__icon--wrapper">
                                                                                                                                                    <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                                                                                                                        ...
                                                                                                                                                        <div classNameName="sidebar__link--text"><button onClick={LoginToggle}>Login</button>
                                                                                                                                                        </div>
                                                                                                                                                        </div>
                                                                                                                                                        </div>
                                                                                                                                                        </div>
                                                                                                                                                        ...
                                                                                                                                                        <div classNameName="container">
                                                                                                                                                            <div classNameName="row">
                                                                                                                                                                <div classNameName="section__title page__title">Settings</div>
