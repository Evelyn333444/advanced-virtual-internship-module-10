...
const toggleSaveBook = () => {
  ...
  if (loading) {
    ...
    return(
        ...
        <div className="inner-book__description">{book.description}<div className="inner-book__icon">
        ...
        <div className="inner-book__key--ideas">{book.keyIdeas}</div>
        </div>
        </div>
        </div>
        ...
        <div className="inner-book__bookmark" onClick={toggleSaveBook} style={{cursor: 'pointer'}}>
  ...
  <div className="inner-book__bookmark--text">
    {isBookSaved ? 'Saved in Library' : 'Add to Library'}
  </div>
</div>
